...
echo get_template_directory_uri();
		 ...
		 echo('<link rel="stylesheet" href="'.get_template_directory_uri().'/responsive.css" type="text/css" />');
echo('
<script type="text/javascript" src="'.get_template_directory_uri().'/js_res.js"></script>');
		echo "</head>\n";
